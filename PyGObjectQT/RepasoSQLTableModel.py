    ...
    def on_filaSeleccionada(self):
        ...
        if indices != []:
            ...
            self.txtEdad.setText(
                str(indices[2].data()))  # Se convierte a string para que se muestre en el campo de texto
            self.cmbGenero.setCurrentText(indices[3].data())
            self.chckFallecido.setChecked(
                bool(indices[4].data()))  # Se convierte a booleano para que se muestre en el campo de texto
